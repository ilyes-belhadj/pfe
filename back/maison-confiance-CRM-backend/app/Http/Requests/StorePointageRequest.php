...
class StorePointageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'heure_entree' => 'nullable|date_format:H:i:s',
            'heure_sortie' => 'nullable|date_format:H:i:s',
            'heure_pause_debut' => 'nullable|date_format:H:i:s',
            'heure_pause_fin' => 'nullable|date_format:H:i:s',
            'heures_travaillees' => 'nullable|numeric|min:0|max:24',
            'heures_pause' => 'nullable|numeric|min:0|max:8',
            'heures_net' => 'nullable|numeric|min:0|max:24',
            'statut' => 'nullable|in:present,absent,en_pause,retard,depart_anticipé',
            'commentaire' => 'nullable|string|max:1000',
            'lieu_pointage' => 'nullable|string|max:100',
            'methode_pointage' => 'nullable|in:manuel,badge,application,geolocalisation',
    ...
    public function messages(): array
    {
        return [
            ...
            'date_pointage.required' => 'La date de pointage est requise.',
