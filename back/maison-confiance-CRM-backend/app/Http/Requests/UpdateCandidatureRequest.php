...
class UpdateCandidatureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'poste_souhaite' => 'sometimes|string|max:255',
            'lettre_motivation' => 'sometimes|string|max:5000',
            'cv' => 'sometimes|file|mimes:pdf,doc,docx|max:10240', // 10MB max
            'lettre_motivation_file' => 'sometimes|file|mimes:pdf,doc,docx|max:5120', // 5MB max
            'statut' => 'sometimes|in:nouvelle,en_cours,entretien_telephone,entretien_rh,entretien_technique,entretien_final,test_technique,reference_check,offre_envoyee,offre_acceptee,embauche,refusee,annulee',
            'priorite' => 'sometimes|in:basse,normale,haute,urgente',
            'date_candidature' => 'sometimes|date',
            'date_derniere_action' => 'sometimes|date',
            'date_entretien' => 'sometimes|date|after:today',
            'heure_entretien' => 'sometimes|date_format:H:i',
            'lieu_entretien' => 'sometimes|string|max:255',
            'notes_entretien' => 'sometimes|string|max:2000',
            'evaluation' => 'sometimes|string|max:2000',
            'note_globale' => 'sometimes|numeric|min:0|max:10',
            'commentaires_rh' => 'sometimes|string|max:2000',
            'commentaires_technique' => 'sometimes|string|max:2000',
            'commentaires_manager' => 'sometimes|string|max:2000',
            'source_candidature' => 'sometimes|string|max:100',
            'campagne_recrutement' => 'sometimes|string|max:100',
            'candidature_spontanee' => 'sometimes|boolean',
            'offre_reference' => 'sometimes|string|max:255',
            'salaire_propose' => 'sometimes|numeric|min:0|max:999999.99',
            'date_debut_souhaite' => 'sometimes|date|after:today',
            'motif_refus' => 'sometimes|string|max:1000',
